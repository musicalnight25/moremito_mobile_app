...
class TmrisLeadDetailsScreen extends StatelessWidget {
  final TmrisLeadModel lead;

  const TmrisLeadDetailsScreen({
    super.key,
    required this.lead,
  });
  ...
  Widget build(BuildContext context) {
    final controller = Get.find<TmrisLeadController>();
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _detailRow("User Name", lead.userName),
            _detailRow("Interest", lead.pageType),
